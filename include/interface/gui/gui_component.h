...
class DLL_PUBLIC GuiComponent {
   ...
   public:  // -------------------- PUBLIC METHODS --------------------
    ...
    virtual void SetWidth(PosPercent const& percent,
                          PosPixel const& offset) final;
    ...
    /// @note Does not affect root components.
    virtual void SetHorizontalPosition(
        PosPercent const& percent, PosPixel const& offset,
        HorizontalAlignment const& alignment) final;

    /// @brief Sets the height.
    /// @param percent The height percentage of the parent height.
    /// @param offset An additional height offset in pixels.
    /// @note Does not affect root components.
    virtual void SetHeight(PosPercent const& percent,
                           PosPixel const& offset) final;
    ...
    /// @note Does not affect root components.
    virtual void SetVerticalPosition(PosPercent const& percent,
                                     PosPixel const& offset,
                                     VerticalAlignment const& alignment) final;
    ...
    virtual void GetSelfRect(PosPixel* out_x, PosPixel* out_y, PosPixel* out_w,
                             PosPixel* out_h) const final;
