...
INTERFACE_INTERNAL void GetRect(
    PosPixel* out_x, PosPixel* out_y, PosPixel* out_w, PosPixel* out_h,
...
INTERFACE_INTERNAL bool IsWithinRect(const PosPixel& x, const PosPixel& y,
                                     const PosPixel& rect_x,
                                     const PosPixel& rect_y,
                                     const PosPixel& rect_w,
